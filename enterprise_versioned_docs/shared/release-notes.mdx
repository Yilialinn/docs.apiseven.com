...
* **[AI Rate Limiting](https://docs.api7.ai/hub/ai-rate-limiting)**
  ...
  * 添加了一个 `rules` 字段，用于同时配置多个限流规则。
* **[AI Proxy](https://docs.api7.ai/hub/ai-proxy)**/**[AI Proxy Multi](https://docs.api7.ai/hub/ai-proxy-multi)**/**[AI Request Rewrite](https://docs.api7.ai/hub/ai-request-rewrite)**
  * 支持 `aimlapi` 供应商.
* **[OpenAPI to MCP](https://docs.api7.ai/hub/openapi-to-mcp)**
